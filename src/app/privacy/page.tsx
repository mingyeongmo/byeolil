    ...
    <div className={styles.page}>
      <main className={styles.main}>
        ...
        <article className={styles.document}>
          ...
          <h1>개인정보처리방침</h1>
          <p className={styles.effectiveDate}>시행일: 2026년 8월 25일</p>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>
                데이터베이스에 저장된 결과는 생성 시점부터 7일 동안 보관합니다.
                보관 기간이 지난 결과는 매일 1회 실행되는 자동 삭제 작업을 통해
                파기되며, 실제 삭제 시점은 보관 기간 만료 후 최대 24시간 이내일
                수 있습니다. 사용자가 그전에 삭제를 요청하면 확인 후 삭제합니다.
              </li>
              <li>
          ...
          <section className={styles.section}>
            ...
            <p>
              ...
              수 있습니다. 보관 기간이 지나 결과가 삭제되면 해당 주소로도 다시
              조회할 수 없습니다.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>
                ...
                요청이 먼저 확인된 경우를 제외하고 생성 시점부터 7일 동안
                보관하며, 보관 기간이 지나면 매일 1회 실행되는 자동 삭제 작업을
                통해 파기합니다.
              </li>
            </ul>
            <p>
          ...
          <section className={styles.section}>
            ...
            <p>
              ...
              파기합니다. 생성 결과는 7일의 보관 기간이 지난 후 매일 1회
              실행되는 자동 삭제 작업을 통해 파기하며, 사용자의 삭제 요청이
              확인되면 보관 기간 전에도 삭제합니다. 데이터베이스에 저장된
              전자적 정보는 복구하기 어려운 방식으로 삭제하며, 서비스 제공업체의
              백업에 남은 정보는 해당 업체의 삭제 절차와 주기에 따라
              파기됩니다.
            </p>
          </section>
          ...
          <section className={styles.section}>
            ...
            <p>
              이 개인정보처리방침은 2026년 8월 25일부터 적용됩니다. 내용이
